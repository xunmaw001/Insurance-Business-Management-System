    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">已有保险管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">已有保险列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">已有保险列表</h3>
                            ...
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                ...
                                                <input type="text" id="nameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                                       placeholder="购买人" aria-controls="tableId">
                                            </label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">申请赔偿设置</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <textarea id="yuanyin" style="width: 300px;height: 100px"></textarea>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="receive" class="btn btn-primary">申请</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        var detailAttr = "shengqing(" + item.id + ')';
        detailBtn.setAttribute("type", "button");
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("gaoumai/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addgaoumai", "addgaoumai");
        window.location.href = "add-or-update.jsp"
    }
    ...
    // 申请
    function renting(role,ids) {
        var mymessage = confirm("真的要申请吗？");
        if (mymessage == true) {
            http("gaoumai/renting?yuanyin="+role+"&ids="+ids, "get", {}, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
