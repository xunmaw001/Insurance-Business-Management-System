    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">赔偿申请管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">赔偿申请列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">赔偿申请列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                                                                                                                 
                                            <label>
                                                申请结果
                                                <select name="jieguoTypesSelectSearch" style="width: 100px;" id="jieguoTypesSelectSearch" class="form-control form-control-sm"
                                            ...
                                            <label>
                                                保险名称
                                                <input type="text" id="bxnameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                            ...
                                            <label>
                                                ...
                                                <input type="text" id="nameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                                       placeholder="购买人名称" aria-controls="tableId">
                                            </label>
...
<script>
    ...
    function search() {
        ...
        if(sexTypesSelectSearchInput != null){
            ...
            //申请结果
        var jieguoTypesSelectSearchInput = document.getElementById("jieguoTypesSelectSearch");
        if(jieguoTypesSelectSearchInput != null){
            var jieguoTypesIndex = jieguoTypesSelectSearchInput.selectedIndex;
            if( jieguoTypesIndex  != 0){
                searchForm.jieguoTypes= document.getElementById("jieguoTypesSelectSearch").options[jieguoTypesIndex].value;
            }
        }
                getDataList();
    }
    ...
    function getDataList() {
        http("shenqing/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            jieguoTypes: searchForm.jieguoTypes,
            //级联表的
    ...
    function setDataRow(item, number) {
        ...
        amountpaidCell.innerHTML = item.amountpaid;
        row.appendChild(amountpaidCell);


        //申请结果
        var jieguoTypesCell = document.createElement('td');
        if(item.jieguoValue == ""|| item.jieguoValue == null){
            jieguoTypesCell.innerHTML = "暂未处理";
        }else{
            jieguoTypesCell.innerHTML = item.jieguoValue;
        }
        row.appendChild(jieguoTypesCell);
        ...
        if(item.jieguoValue == ""|| item.jieguoValue == null){
            //详情按钮
            var detailBtn = document.createElement('button');
            var detailAttr = "agreement(" + item.id + ')';
            detailBtn.setAttribute("type", "button");
            detailBtn.setAttribute("class", "btn btn-success btn-sm 同意");
            detailBtn.setAttribute("onclick", detailAttr);
            detailBtn.innerHTML = "同意"
            btnGroup.appendChild(detailBtn)
    ...
    function reject(id) {
        ...
        if (mymessage == true) {
            http("shenqing/reject?ids="+id, "get", {}, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('成功拒绝');
                }
    ...
    function agreement(id) {
        ...
        if (mymessage == true) {
            http("shenqing/agreement?ids="+id, "get", {}, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('成功同意');
                }
    ...
    //填充本表搜索下拉框
        ...
        function jieguoTypesSelectSearch() {
            var jieguoTypesSelectSearch = document.getElementById('jieguoTypesSelectSearch');
            if(jieguoTypesSelectSearch != null) {
                jieguoTypesSelectSearch.add(new Option('-请选择-',''));
                if (jieguoTypesOptions != null && jieguoTypesOptions.length > 0){
                    for (var i = 0; i < jieguoTypesOptions.length; i++) {
                            jieguoTypesSelectSearch.add(new Option(jieguoTypesOptions[i].indexName,jieguoTypesOptions[i].codeIndex));
                    }
                }
            }
        }
